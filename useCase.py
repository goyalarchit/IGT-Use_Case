...
print(u)
print("Variance of Type Sets of Academy Representatives")
print(s)
...
print("Mean Of SD of Academy Representatives : {}".format(us))
print("Deviation of Academy Representatives ")
print(ss)
print("a: {}, \tb: {}, \tM: {}, \tMAF: {}".format(a,b,M,MAF))
print("Utility of Players")
print(player_utility)
print("Sum of Utility of All Players: {}".format(all_u))
print("Utility of Representatives")
